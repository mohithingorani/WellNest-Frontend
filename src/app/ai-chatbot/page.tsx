...
// //   }
// // };
// const fetchValue = async(message:string, context:string[])=>{
//     return "asdf"
// }
...
//           <div className="flex flex-col flex-grow bg-[#0D0D0D]/20 p-8 overflow-y-auto shadow-lg rounded-xl bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-50 mx-4">
//           <div className="text-2xl w-full flex justify-start items-center gap-4">
//             <Image className="object-contain rounded-full" src={"/tuntun.jpg"} width={"40"} height={"40"} alt="tuntun mausi"/>
//             <div>Tuntun Mausi</div></div>
...
//               type="text"
//               value={message}
//               className="w-full focus:ring-0 outline-none px-3 py-1.5 resize-none text-white backdrop-filter backdrop-blur-sm border rounded-xl shadow-md border-none"
